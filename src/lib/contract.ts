export const STAKE_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STAKE_ADDRESS as `0x${string}` || '0x62b7C03E5A42fedE09D1b862Cb7936B26fDc5c1e';

export const PID = 0; // Pool ID for ETH staking

// 添加合约地址验证
export const isValidContractAddress = () => {
  return STAKE_CONTRACT_ADDRESS !== '0x0000000000000000000000000000000000000000';
};
